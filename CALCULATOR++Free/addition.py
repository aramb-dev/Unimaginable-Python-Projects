print("Welcome to the FREE version of Calculator++! This calculator has the ability to add. This calculator is only compatible with six numbers. If you have any issue with this calculator then go to this link:\n https://github.com/aramservices198/Unimaginable-Python-Projects/issues/new")
