print("Welcome to the FREE version of Calculator++! This calculator has the ability to add. This calculator is only compatible with four numbers. If you have any issue with this calculator")
