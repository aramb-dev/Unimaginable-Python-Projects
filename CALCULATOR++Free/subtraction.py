print("Welcome to the FREE version of Calculator+! This calculator has the ability to subtract.  This calculator is only compatible with four numbers. If you have any issue with this calculator then go here: \n https://github.com/aramservices198/Unimaginable-Python-Projects/issues/new")
